...
// Не совсем понял, что значит "Легкость добавления других фигур".
// Создал класс - новую фигуру, реализовал интерфейс и добавил необходимые конструкторы, свойства и поля.
// Вроде бы легко. Но может быть вы что-то другое имели ввиду.
